<template>
  <DefaultLayout>
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow p-6">
      <h1 class="text-xl font-semibold mb-6">编辑单词</h1>
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.library_id" class="w-full border rounded-lg p-2">
...
const form = useForm({
  ...
  library_id: props.word.library_id,
...
const submit = () => {
  form.put(route('admin.words.update', props.word.id))
}
</script>
